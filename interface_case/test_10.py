...
from common.check_result import CheckDetail
from common.get_database import Database
...
class TestReverse(unittest.TestCase):
    ...
    def testReverse(self,id,description,interface,method,data,associate_id,get_param,set_param,ignore_key,message):
        ...
        LocalConfigHttp.set_data(datas.encode('utf-8').decode('latin1'))#设置入参
        ...
        #详细断言
        # check_detail = CheckDetail(self.case_id,self.ignore_key,sheet_name,content)
